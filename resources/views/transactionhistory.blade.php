...
<body>
    <div class="transaction-history-body-container">
        ...
        <div class="transaction-history-card transaction-history-group">
                      ...
                      <div class="transaction-history-card-body p-4">
                        <div class="row">
                            ...
                            <div class="col transaction-history-card-midside">
                                ...
                                <p class="transaction-history-card-year pt-1">[YEAR]</p>
                                <p class="transaction-history-card-price">Rp [PRICE]</p>
                                <p class="transaction-history-card-quantity">[QUANTITY] pc(s)</p>
